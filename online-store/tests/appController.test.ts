...
describe('AppController\'s "filterByProperty" method for products filtering', (): void => {
  const controller = new AppController(AppSettings);
...
describe('AppController\'s "sortByProperty" method for products sorting', (): void => {
  const controller = new AppController(AppSettings);
...
describe('AppController\'s "searchByProperty" method for products searching', (): void => {
  const controller = new AppController(AppSettings);
